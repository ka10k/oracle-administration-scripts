...
--TB_SERVICES   
SELECT 'PART' || TO_CHAR(ADD_MONTHS (sysdate, -17), 'YYYY_MM') into part from dual;

SELECT TO_CHAR(ADD_MONTHS (sysdate, -17), 'YYYY-MM') into dttm_start from dual; --same as PART 
SELECT TO_CHAR(ADD_MONTHS (sysdate, -16), 'YYYY-MM') into dttm_end from dual; -- PART + 1
