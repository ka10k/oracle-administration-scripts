...
--DBMS_STATS.GATHER_TABLE_STATS(ownname => 'SIP', tabname => 'TB_SERVICES', partname => part, cascade => TRUE, ESTIMATE_PERCENT => NULL, granularity => 'PARTITION',DEGREE=>8);
...
select * from SIP.TB_SERVICES where
