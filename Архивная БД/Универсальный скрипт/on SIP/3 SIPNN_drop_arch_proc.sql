...
IF numrows=numrows_arch THEN
    ...
    execute immediate 'create table SIP_W.TB_SERVICES_DEL as select * from SIP_W.TB_SERVICES where 1=2';
    --execute immediate 'alter table SIP_W.TB_SERVICES exchange partition '||part||' with table SIP_W.TB_SERVICES_DEL INCLUDING INDEXES without validation';
    execute immediate 'alter table SIP_W.TB_SERVICES exchange partition '||part||' with table SIP_W.TB_SERVICES_DEL without validation';
    execute immediate 'drop table SIP_W.TB_SERVICES_DEL';
