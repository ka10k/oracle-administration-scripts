CREATE INDEX SIP_W.TWSA_SD ON SIP_W.TB_WTMPS_SESSIONS_ARCHIVE
(TWSA_START_DATE)
  TABLESPACE INDX
  PCTFREE    10
  INITRANS   5
...
CREATE INDEX SIP_W.TWSC_SD ON SIP_W.TB_WTMPS_SESSION_CHARGES
(TWSC_SESSION_DATE)
  TABLESPACE INDX
  PCTFREE    10
  INITRANS   5
...
CREATE INDEX SIP_W.TWH_D ON SIP_W.TB_WTMPS_ARCHIVE
(TWH_DATE)
  TABLESPACE INDX
  PCTFREE    10
  INITRANS   5
...
CREATE INDEX SIP_W.SRV_D ON SIP_W.TB_SERVICES
(SRV_DATE)
  TABLESPACE INDX
  PCTFREE    10
  INITRANS   5
...
ALTER INDEX SIP_W.TWSA_SD NOPARALLEL;
ALTER INDEX SIP_W.TWSC_SD NOPARALLEL;
ALTER INDEX SIP_W.TWH_D NOPARALLEL;
ALTER INDEX SIP_W.SRV_D NOPARALLEL;
/