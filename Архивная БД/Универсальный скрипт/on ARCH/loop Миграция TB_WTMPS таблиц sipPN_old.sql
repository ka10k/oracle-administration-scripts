...
--Проверка
    ...
    /*
select num_rows into numrows_arch from SIP_PN.PART_VIEW where table_name='TB_WTMPS_SESSIONS_ARCHIVE' and partition_name=part; --кол-во в архивной бд
...
insert /*+ APPEND */ into SIP_PN.TB_WTMPS_SESSIONS_ARCHIVE 
select * from TB_WTMPS_SESSIONS_ARCHIVE@SIPPN_OLD where
...
--Проверка
/*
select num_rows into numrows_arch from SIP_PN.PART_VIEW where table_name='TB_WTMPS_ARCHIVE' and partition_name=part; --кол-во в архивной бд
...
insert /*+ APPEND */ into SIP_PN.TB_WTMPS_ARCHIVE 
select * from TB_WTMPS_ARCHIVE@SIPPN_OLD where
...
--Проверка
/*
select num_rows into numrows_arch from SIP_PN.PART_VIEW where table_name='TB_WTMPS_SESSION_CHARGES' and partition_name=part; --кол-во в архивной бд
...
insert /*+ APPEND */ into SIP_PN.TB_WTMPS_SESSION_CHARGES 
select * from TB_WTMPS_SESSION_CHARGES@SIPPN_OLD where
...
commit;
execute immediate 'ALTER SESSION CLOSE DATABASE LINK SIPPN_OLD'; --1 раз или 4 ?
