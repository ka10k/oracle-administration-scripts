...
--Проверка
select num_rows into numrows_arch from SIP_ML.PART_VIEW where table_name='TB_SERVICES' and partition_name=part; --кол-во в архивной бд
...
insert /*+ APPEND */ into SIP_ML.TB_SERVICES
select * from TB_SERVICES@SIPML_OLD where
...
commit;
execute immediate 'ALTER SESSION CLOSE DATABASE LINK SIPML_OLD'; --1 раз или 4 ?
