...
--Проверка
select num_rows into numrows_arch from SIP_KR.PART_VIEW where table_name='TB_SERVICES' and partition_name=part; --кол-во в архивной бд
...
insert /*+ APPEND */ into SIP_KR.TB_SERVICES
select * from TB_SERVICES@SIPKR_OLD where
