...
--Проверка
--select num_rows into numrows_arch from SIP_OR.PART_VIEW where table_name='TB_SERVICES' and partition_name=part; --кол-во в архивной бд
...
insert /*+ APPEND */ into SIP_OR.TB_SERVICES
select * from TB_SERVICES@SIPOR_OLD where
