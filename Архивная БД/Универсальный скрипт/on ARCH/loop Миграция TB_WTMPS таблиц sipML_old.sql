...
--Проверка
    ...
    /*
select num_rows into numrows_arch from SIP_KR.PART_VIEW where table_name='TB_WTMPS_SESSIONS_ARCHIVE' and partition_name=part; --кол-во в архивной бд
...
insert /*+ APPEND */ into SIP_KR.TB_WTMPS_SESSIONS_ARCHIVE 
select * from TB_WTMPS_SESSIONS_ARCHIVE@SIPKR_OLD where
...
--Проверка
/*
select num_rows into numrows_arch from SIP_KR.PART_VIEW where table_name='TB_WTMPS_ARCHIVE' and partition_name=part; --кол-во в архивной бд
...
insert /*+ APPEND */ into SIP_KR.TB_WTMPS_ARCHIVE 
select * from TB_WTMPS_ARCHIVE@SIPKR_OLD where
...
--Проверка
/*
select num_rows into numrows_arch from SIP_KR.PART_VIEW where table_name='TB_WTMPS_SESSION_CHARGES' and partition_name=part; --кол-во в архивной бд
...
insert /*+ APPEND */ into SIP_KR.TB_WTMPS_SESSION_CHARGES 
select * from TB_WTMPS_SESSION_CHARGES@SIPKR_OLD where
...
commit;
execute immediate 'ALTER SESSION CLOSE DATABASE LINK SIPKR_OLD'; --1 раз или 4 ?
