...
--Проверка
    ...
    /*
select num_rows into numrows_arch from SIP_RM.PART_VIEW where table_name='TB_WTMPS_SESSIONS_ARCHIVE' and partition_name=part; --кол-во в архивной бд
...
--Проверка
/*
select num_rows into numrows_arch from SIP_RM.PART_VIEW where table_name='TB_WTMPS_ARCHIVE' and partition_name=part; --кол-во в архивной бд
...
--Проверка
/*
select num_rows into numrows_arch from SIP_RM.PART_VIEW where table_name='TB_WTMPS_SESSION_CHARGES' and partition_name=part; --кол-во в архивной бд
...
commit;
execute immediate 'ALTER SESSION CLOSE DATABASE LINK SIPRM_OLD'; --1 раз или 4 ?
