...
(function() {
    var lotme = document.createElement('script');
    lotme.type = 'text/javascript';
    lotme.async = true;
    lotme.onload = function() {
        _cc9193.add("behavior", "B : 1111754")
        _cc9193.bcp();
    };
    lotme.id = 'LOTCC_9193';
    lotme.src = document.location.protocol + '//tags.crwdcntrl.net/c/9193/cc.js?ns=_cc9193';
    var s = document.getElementsByTagName('script')[0];
    s.parentNode.insertBefore(lotme, s);
})();
