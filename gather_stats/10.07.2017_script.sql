...
for t in(select owner,table_name from dba_tables MINUS select distinct table_owner,table_name from dba_tab_partitions where partition_name like 'PART%' and TABLE_NAME not like 'BIN%')
