alter table SIP_W.TB_WTMPS_SESSIONS_ARCHIVE split partition PART_MAXVALUE at
...
alter table SIP_W.TB_WTMPS_SESSION_CHARGES split partition PART_MAXVALUE at
(TO_DATE('032015','mmyyyy')) into 
(partition PART2015_02, partition PART_MAXVALUE) update global indexes;
alter table SIP_W.TB_WTMPS_SESSION_CHARGES split partition PART_MAXVALUE at
(TO_DATE('042015','mmyyyy')) into 
